...
1) **Why can these features not be implemented in crates, why does it need compiler support?**
...
2) **What are related crates or projects?**
...
3) **What are the paths towards stabilization?**
