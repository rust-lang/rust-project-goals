...
The importance of having an ironclad safety guarantee has increased due to the rise of agentic coding, especially when that work is unsupervised or lightly supervised. Knowing that, no matter what mischief an agent produces, it will never violate memory safety gives users an important guardrail.
